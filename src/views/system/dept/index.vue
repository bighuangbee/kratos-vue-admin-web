<template>
  <div class="app-container">
    <el-card shadow="always">
      ...
      <el-form :model="state.queryParams" ref="queryForm" :inline="true" label-width="68px">
        <el-form-item label="部门名称" prop="deptName">
          <el-input placeholder="请输入部门名称模糊查询" clearable @keyup.enter.native="handleQuery"
    ...
    <el-card class="box-card">
      ...
      <!--数据表格-->
      <el-table v-loading="state.loading" :data="state.tableData" row-key="deptId" border default-expand-all
...
import { sys_normal_disable } from "@/utils/dictionary";
